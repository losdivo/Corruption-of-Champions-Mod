package classes.Scenes.Places{
	...
	public var breastMilkingScene:BreastMilkingScene = new BreastMilkingScene();
...
public function farmExploreEncounter():void {
	...
	//Repeat Offender
		...
		if (player.hasKeyItem("Breast Milker - Installed At Whitney's Farm") >= 0) {
			...
			else if (flags[kFLAGS.WHITNEY_FLIPPED_OUT_OVER_KELLY] == 0) addButton(2,"Get Milked",breastMilkingScene.getMilked);
