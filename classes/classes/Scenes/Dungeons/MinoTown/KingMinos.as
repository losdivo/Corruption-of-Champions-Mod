package classes.Scenes.Dungeons.MinoTown 
{
	...
	public class KingMinos extends Monster
	{
		...
		override public function get long():String
		{
			...
			if (!_orgasms == 0)
			{
				return "Standing in the center of large throne room is an opponent of singular size and stature - the Minotaur King. He is a beast beyond measure, covered in shaggy fur and a few scraps of leather that do nothing to hide the pillar of flared cuntplow between his legs. In his hands is a gigantic axe, though he seems loathe to use it, preferring to rely on the erotic scent emanating from between his legs. He smells virile, strong, and more alluring than you’d expect. You’d best be careful not to dwell on it.";
			}
			str = "Still standing in the center of throne room, the Minotaur King is breathing heavily. His cock is slathered with the residue of his own potent orgasm. His immense, 14 foot tall form hunches slightly as he stares at you, one hand still clutching to his axe. Driving him back to his peak would undoubtedly push him even beyond his considerable endurance. The only problem is that alluring <i>aroma</i> that surrounds him, suffusing the air with the scent of sweaty bedroom romps and sizzling pleasure. You better finish him quick.";
			if (lust < 40)
			{
		...
		override public function defeated(hpVictory:Boolean):void
		{
			...
			game.dungeons.minotown.king.theKingIsDeadLongLiveTheKing(hpVictory);
		}
		
		override public function won(hpVictory:Boolean, pcCameWorms:Boolean):void
		{
			game.dungeons.minotown.king.minotaurKing.hailToTheKingBaby(hpVictory,pcCameWorms);
		}
